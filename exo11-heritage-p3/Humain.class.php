...
echo '<h1>La programmation orienté objet (POO) - Héritage (Partie 3) - <mark>Encapsulation</mark></h1>';
echo '<h2>/!\ J\'ai déplacer le constructeur dans chaque classe afin de voir le comportement de la visibilitée <mark>protected</mark> /!\</h2>';
...
echo '<pre>'.var_dump($mySecondHomme).'</pre>';
echo '<mark>Ici, pour les 2 classes, il nous est tout à fait possible de récupérer le contenu de la classe Humain</mark>';
